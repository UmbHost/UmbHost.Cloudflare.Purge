...
const m = {
  ...
  kind: "default",
  weight: 50,
  api: () => import("./purge-content-tree-entity.action-CdSexDzZ.js"),
  forEntityTypes: [i],
  meta: {
    icon: "icon-cloud",
  ...
  element: () => import("./purge-dashboard-BgsBNT6J.js"),
  ...
  element: () => import("./caching-r-aqwp5x.js"),
...
//# sourceMappingURL=entry-CN_QVRCi.js.map
