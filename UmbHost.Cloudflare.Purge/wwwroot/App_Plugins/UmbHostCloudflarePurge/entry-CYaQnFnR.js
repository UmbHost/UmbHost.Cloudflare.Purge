...
const m = {
  ...
  kind: "default",
  weight: 50,
  api: () => import("./purge-content-tree-entity.action-DuOWzD1-.js"),
  forEntityTypes: [i],
  meta: {
    icon: "icon-cloud",
  ...
  element: () => import("./purge-dashboard-C8kJQUZ9.js"),
  ...
  element: () => import("./caching-DDW_WdUB.js"),
...
//# sourceMappingURL=entry-CYaQnFnR.js.map
